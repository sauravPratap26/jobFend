    ...
    return (
        <div onClick={()=> navigate(`/description/${job._id}`)} className='p-5 rounded-md shadow-xl bg-white border border-gray-100 cursor-pointer'>
            ...
            <div>
                ...
                <p className='text-sm text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores quisquam debitis aperiam maxime voluptatum, quaerat ut voluptate eos at omnis sequi modi accusantium optio laudantium fugiat enim? Alias, eos recusandae.</p>
            </div>
